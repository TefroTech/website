...
import { idlFactory } from './tefro.did.js';
export { idlFactory } from './tefro.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TEFRO;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tefro.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tefro canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tefro.did.js")._SERVICE>}
 */
export const tefro = createActor(canisterId);
